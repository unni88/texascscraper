		...
		for caseinfoline in casedetsreadlines:		
			ci = caseinfoline.split("##")
		  	if((len(ci) >= 4)  and  ("done" in ci[3])):					   			
					print (ci[3])
					htmltexttowrite = htmltexttowrite + "<tr><td style='border: 2px solid #CCC;'>"+ci[0]+"</td><td style='border: 2px solid #CCC;'>"+ci[1]+'</td><td style="border: 2px solid #CCC;"><a href="'+ci[2][1:-1]+'" title="See Video">'+"See Video"+"</a></td></tr>"
